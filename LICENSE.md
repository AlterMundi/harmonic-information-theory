...
This repository contains the editorial source of the book:

**Harmonic Information Theory**

## Authorship

**Authors:** Mariano Fernández Méndez and Nicolás Echániz  
**Compilation and final writing:** Mariano Fernández Méndez

## Institutional Framework

This work was developed and published within the institutional framework of **Asociación Civil AlterMundi**.
...
This repository contains the LaTeX source of the book and the editorial materials directly related to its composition and publication. It is not the general repository of the broader research program, nor the canonical repository of all experimental branches associated with Phideus, Beacon, or related work.

## License

Unless otherwise indicated, the contents of this repository are licensed under:
...
- **No endorsement** — You may not imply that the authors or Asociación Civil AlterMundi endorse you or your use without express authorization.
...
Any third-party material identified as such is excluded from this license unless explicitly stated otherwise and remains subject to its own copyright and licensing conditions.
