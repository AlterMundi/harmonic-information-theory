...
\printbibliography[keyword=information-theory, heading=subbibliography, title={Information Theory}]
\printbibliography[keyword=process-philosophy, heading=subbibliography, title={Process Philosophy}]
...
\printbibliography[keyword=interdisciplinarity, heading=subbibliography, title={Interdisciplinarity and Boundary Objects}]
...
\printbibliography[keyword=just-intonation, heading=subbibliography, title={Just Intonation and Tuning Systems}]
...
\printbibliography[keyword=thermodynamics, heading=subbibliography, title={Thermodynamics and Computation}]
\printbibliography[keyword=biological-sense, heading=subbibliography, title={Biological Sensitivity to Harmony}]
...
\printbibliography[keyword=polyvagal, heading=subbibliography, title={Polyvagal Theory}]
