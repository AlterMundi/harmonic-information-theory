...
\footnotesize
\begin{tabularx}{\textwidth}{@{}P{0.15\textwidth}P{0.14\textwidth}Y P{0.20\textwidth}Y@{}}
\toprule
Register & Probe & Question & State & Evidence \\
\midrule
Computa\-tional & Phideus & Do proportional descriptions reorganize cross-modal representation? & Closed positive & Causal controls + multi-seed replication \\
