...
\midrule
Retrieval & Eval-seed reference & $84.1\% \pm 2.3$pp (\texttt{d4a4}) & Strong guided reference; full training-seed replication pending \\
...
\begin{table}[ht]
\centering
\caption{Canonical cross-modal retrieval reference across the main Escalon~1 arms ($n = 5$ per row; \texttt{d4a4} uses evaluation seeds over a fixed checkpoint).}
