...
App/\newline Distributed & Live remote Beacon node, streaming & Extends device into platform & Universal & Configurable \\
\bottomrule
\end{tabularx}
...
\begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth, height=5.5cm, keepaspectratio]{Beacon1.png}
